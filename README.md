# راهنمای کامل دیتابیس محصولات دیجیکالا

## معرفی
این دیتابیس شامل اطلاعات کامل محصولات و دسته‌بندی‌های دیجیکالا به همراه داده‌های کارمزد و ساختار سلسله‌مراتبی دسته‌بندی‌ها می‌باشد. فایل SQL ارائه شده یک دامپ کامل از دیتابیس است.
